...
if (isset($_POST['login'])) { // Check if submit button has been pressed.#fdf1f1
	...
	$_GET = protection($_GET); // Protect the $_GET variable.
		...
		if(empty($_POST['username']) || empty($_POST['password'])) { // Check if the form fields are empty or not.
			...
			$chkuser = mysql_query("SELECT * FROM `users` WHERE `username` = '".$_POST['username']."' && `password` = '".md5($_POST['password'])."' AND `group`='admin' LIMIT 0, 1" ); // Check if the username and password are correct.
...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Administrator Login - SeaGods Wetsuit</title>
  ...
  <body class="fixed-header ">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="assets/img/demo/undersea.jpg" data-src="assets/img/demo/undersea.jpg" data-src-retina="assets/img/demo/undersea.jpg" alt="" class="lazy">
        <!-- END Background Pic-->
...
By Pass I Gusti Ngurah Rai no. 376, Sanur - Denpasar 80228, Bali - Indonesia © 2018.
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <img src="assets/img/s-logo.png" alt="logo"  data-src="assets/img/s-logo.png" data-src-retina="assets/img/s-logo.png"  height="22px"> <b>SEAGODS WETSUIT</b>
