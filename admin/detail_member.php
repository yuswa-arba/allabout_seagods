...
if ($loggedin = logged_inadmin()) { // Check if they are logged in
    ...
    $back_to_list = (isset($_GET['frm']) ? (($_GET['frm'] == 'admin') ? 'list_admin.php' : 'list_member.php') : 'list_member.php');
                    ...
                    <div class="card card-default">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <a href="' . $back_to_list . (isset($_GET['page']) ? '?page=' . $_GET['page'] : '') . '" class="btn btn-outline-primary pull-right" name="">Back to List</a>
                        </div>
                    </div>
