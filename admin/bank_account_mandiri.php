...
if ($loggedin = logged_inadmin()) { //  Check if they are logged in
    ...
    $titlebar = "Mandiri - Bank Account";
    $titlepage = "Mandiri - Bank Account";
                    ...
                    <div class="card-block no-scroll card-toolbar">
                        <form method="post" action="" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group form-group-default ">
                                <input class="form-control" name="title" value="READ ONLY - MANDIRI">
                            </div>
                            <div class="form-group form-group-default required ">
                                <input class="form-control" name="title" value="03242423424">
                            </div>
