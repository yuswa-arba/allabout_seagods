...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>SeaGods Admin Page</title>
      ...
      <div class="container">
        ...
        <div class="menu-bar header-sm-height" data-pages-init='horizontal-menu' data-hide-extra-li="0">
          ...
          <ul>
            ...
            <li>
              <a href="list-member.php"><span class="title">Members</span></a>
            </li>
            <li>
            ...
            <span class=" arrow"></span></a>
              <ul class="">
                <li class="">
                  <a href="list-products.php">List Products</a>
                </li>
                <li class="">
                  <a href="trash-products">List Categories</a>
                </li>
            ...
            <span class=" arrow"></span></a>
              <ul class="">
				...
				<li class="">
                  <a href="buyers-guide.php">Buyers Guide</a>
                </li>
				<li class="">
                  <a href="custom-guide.php">Custom Guide</a>
                </li>
				<li class="">
                  <a href="payment-guide.php">Payment Guide</a>
                </li>
              </ul>
            </li>
			<li>
              <a href="list-contact-us.php">Incoming Contact Us</a>
            </li>
                ...
                <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle d-flex flex-column align-self-stretch">
                  ...
                  <div class="auto-overflow widget-11-2-table">
                    <table class="table table-condensed table-hover">
                      <tbody>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 w-50">MEMBER NAME</td>
                          <td class="text-right b-r b-dashed b-grey w-25">
                            <span class="hint-text small">view</span>
                          </td>
                          <td class="text-right b-r b-dashed b-grey w-25">
                            <span class="hint-text small">MLG</span>
                          </td>
                          <td class="w-25">
                            <span class="font-montserrat fs-18">IND</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 w-50">MEMBER NAME</td>
                ...
                <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle d-flex flex-column align-self-stretch">
                  ...
                  <div class="auto-overflow widget-11-2-table">
                    <table class="table table-condensed table-hover">
                      <tbody>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 w-50">BLUE WETSUIT</td>
                          <td class="text-right b-r b-dashed b-grey w-25">
                            <span class="hint-text small">Member</span>
                          </td>
                          <td class="text-right b-r b-dashed b-grey w-25">
                            <span class="hint-text small">IDR 123K</span>
                          </td>
                          <td class="w-25">
                            <span class="font-montserrat fs-18">Proses</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 w-50">BLUE WETSUIT</td>
