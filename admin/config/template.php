...
<div class="menu-bar header-sm-height" data-pages-init=\'horizontal-menu\' data-hide-extra-li="0">
          ...
          <ul>
            ...
            <ul class="">
                ...
                <li class="">
                  <a href="custom_made.php">Custom Made</a>
                </li>
                <li>
                <a href="list_shipping.php"><span class="title">Shipping</span></a>
                </li>
                <li class="">
                  <a href="list_bank_account.php">Bank Account</a>
                </li>
                </ul>
            </li>
			<li>
            ...
            <span class=" arrow"></span></a>
              <ul class="">
                ...
                <li class="">
                  <a href="pricing_guide.php">Pricing Guide</a>
                </li>
                <li>
            ...
            <li>
              <a href="list_blog.php"><span class="title">Blog</span></a>
            ...
            <ul class="">
            <li>
              <a href="list_subscriber.php"><span class="title">Subscriber</span></a>
            </li>
      ...
      <div class="container">
        ...
        <div class="header-inner justify-content-start header-lg-height title-bar">
          <div class="brand inline align-self-end">
            <a href="home.php"><img src="assets/img/s-logo.png" style="width:35px;" ></a>
          </div>
