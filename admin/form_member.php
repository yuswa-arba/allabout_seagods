    ...
    if ($update == "Update") {
        ...
        if (!empty($firstname) && !empty($lastname) && !empty($email) && !empty($phonenumber)) {
            ...
            echo "<script language='JavaScript'>
                ...
                location.href = 'list_member.php" . (isset($_GET['page']) ? '?page=' . $_GET['page'] : '') . "';
            </script>";
            exit();
...
// Bank query
    ...
    $content .= '
                                ...
                                <a href="list_member.php' . (isset($_GET['page']) ? '?page=' . $_GET['page'] : '') . '" class="btn btn-outline-primary pull-right" name="">Back to List</a>
