...
if ($cart = isset($_POST["submit"]) ? $_POST["submit"] : "") {
    if ($cart == "add to cart") {
        ...
        // Select Member or filter memeber
        $select = mysql_query('select * from custom_cart where id_member="' . $loggedin["id_member"] . '"');
        $data = mysql_fetch_array($select);
        $id_member = $data["id_member"];

        // Data code custom for update, if null or empty, then process code will show alert 'Save your custom image first!'
        $kode_custom_cart = isset($_POST["kode_custom_cart"]) ? $_POST["kode_custom_cart"] : "";

        if ($id_member != $loggedin["id_member"] || $kode_custom_cart == "") {
            echo "<script language='JavaScript'>
                    alert('Save your custom image first');
                    location.href = 'index.php';
                  </script>";
        } else {
            // TODO tambahkan where data dengan $kode_custome_cart
            // Update Cart
            $sql = "update `custom_cart` set  `gender` = '$gender', `wet_suit_type` = '$wetsuit' , `arm_zipper` = '$armZipper' , `ankle_zipper` = '$ankleZipper' 
                ...
                ajax.onload = function () {
                    if (ajax.readyState === ajax.DONE) {
                        if (ajax.status === 200) {
                            ...
                            $('[name="kode_custom_cart"]').val(ajax.responseText);
        ...
        <div class="container">
            ...
            <div id="custom" style="display: none;">
                <div class="row">
                            ...
                            <div id="custom-female" class="row custom-gender" style="display: none;">
                                <div class="col-sm-12">
                                    <div class="wetsuit-box">
                                        ...
                                        <img class="side-front_zip" id="side-front_zip-2" src="public/custom/wetsuit/female-new/back_zip.png"
                                             alt="" style="display: none;">
                                        <img class="side-hand_zip" id="side-hand_zip-2" src="public/custom/wetsuit/female-new/hand_zip.png"
                                             alt="" style="display: none;">
                                        <img class="side-leg_zip" id="side-leg_zip-2" src="public/custom/wetsuit/female-new/leg_zip.png"
                                             alt="" style="display: none;">
                            ...
                            <div id="custom-unisex" class="row custom-gender" style="display: none;">
                                <div class="col-sm-12">
                                    <div class="wetsuit-box">
                                        ...
                                        <img class="side-front_zip" id="side-front_zip-3" src="public/custom/wetsuit/unisex_new/back_zip.png"
                                             alt="" style="display: none;">
                                        <img class="side-hand_zip" id="side-hand_zip-3" src="public/custom/wetsuit/unisex_new/hand_zip.png"
                                             alt="" style="display: none;">
                                        <img class="side-leg_zip" id="side-leg_zip-3" src="public/custom/wetsuit/unisex_new/leg_zip.png"
                                             alt="" style="display: none;">
                  ...
                  <button  type="button" class="btn btn-default text-center" onclick="saveViaAJAX();">Save Project</button>';
                            }
                            ?>
                        </div>
                    </div>
