...
$baseUrl = 'http://localhost/seagods/member';
$redirectUrls = new RedirectUrls();
$redirectUrls->setReturnUrl("$baseUrl/testing_payment_list.php?success=true")
    ->setCancelUrl("$baseUrl/testing_payment_list.php?success=false");
